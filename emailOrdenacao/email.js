const emails = [{
    ...
    mensagem: "Nenhum poder na Terra é capaz " +
    "de deter uma pessoa oprimida determinada " +
    ...
    remetente: "Ollu",
    destinatario: "Dagkoael",
    data: "03/08/2015",
    tipo: ""
}, {
    assunto: "Registro vencido",
    mensagem: "É mais fácil repousar um corpo " +
    "dolorido do que acalmar uma alma exausta.",
    remetente: "Ollu",
    destinatario: "Amzexi",
    data: "05/08/2019",
    tipo: "RE: "
    ...
    mensagem: "Não haverá borboletas se a vida " +
    "não passar por longas e silenciosas metamorfoses.",
    remetente: "Ollu",
    destinatario: "Ovcueus",
    data: "05/08/2000",
    tipo: "RE: "
}, {
    assunto: "Solicitação de feedback",
    mensagem: "A distância não significa nada quando alguém significa tudo.",
    remetente: "Garoesgarn",
    destinatario: "Ollu",
    data: "06/09/2019",
    tipo: "RE: "
}, {
    assunto: "Registro vencido",
    mensagem: "Comece onde você está, use o que você " +
    "tem e faça o que você pode.",
    remetente: "Amzexi",
    destinatario: "Ollu",
    data: "16/08/2019",
    tipo: "FW: "
    ...
    assunto: "Registro vencido",
    mensagem: "O segredo para ser feliz é aceitar onde " +
    "você está hoje na vida e dar o melhor de si todos os dias.",
    remetente: "Ollu",
    destinatario: "Amzexi",
    data: "11/08/2019",
    tipo: ""
...
function ordenarData(){
    ...
    emails.forEach(function(email){
        ...
        list.innerHTML = "<li class='elemento'>" +
                                ...
                                email.mensagem +
                                "</span>" +
                                "<span class='envolvidos'> Remetente: " +
                                email.remetente +
                                " / Destinatário: " +
                                email.destinatario +
                                "</span>" +
